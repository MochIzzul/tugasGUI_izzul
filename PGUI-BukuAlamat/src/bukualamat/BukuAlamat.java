...
/**
*
* @author Moch. Izzul Haq Fachrezi Efendi Putra
*/
...
public BukuAlamat(){
    dataperson.add(new DataPersonal("Izzul", "Fachrezi"));
    dataperson.add(new DataPersonal("Budi", "Santoso"));
    dataperson.add(new DataPersonal("Joko", "Widodo"));
    dataperson.add(new DataPersonal("Risma", "Harini"));
    dataperson.add(new DataPersonal("Ari", "Lasso"));
    dataperson.add(new DataPersonal("Ahmad", "Dhani"));
}
